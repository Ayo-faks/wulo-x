...
from apps.artagent.backend.voice.voicelive.credentials import get_voicelive_credential
        ...
        if session_obj:
            ...
            if turn_detection:
                payload["turn_detection"] = {
                    ...
                    "prefix_padding_ms": getattr(turn_detection, "prefix_padding_ms", None),
                    ...
                    "auto_truncate": getattr(turn_detection, "auto_truncate", None),
...
class VoiceLiveSDKHandler:
    ...
    @staticmethod
    async def _build_credential(settings) -> AzureKeyCredential | AsyncTokenCredential:
        return await get_voicelive_credential(settings)
