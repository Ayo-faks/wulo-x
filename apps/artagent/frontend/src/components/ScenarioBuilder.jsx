...
const colors = {
  start: { bg: 'rgba(78, 201, 176, 0.14)', border: 'var(--vsc-success)', avatar: 'var(--vsc-success)' },
  active: { bg: 'rgba(var(--vsc-accent-rgb), 0.14)', border: 'var(--vsc-accent)', avatar: 'var(--vsc-accent)' },
  inactive: { bg: 'var(--vsc-panel-bg)', border: 'var(--vsc-border)', avatar: 'var(--vsc-fg-muted)' },
  selected: { bg: 'rgba(var(--vsc-accent-rgb), 0.16)', border: 'var(--vsc-accent)', avatar: 'var(--vsc-accent)' },
  session: { bg: 'rgba(204, 167, 0, 0.18)', border: 'var(--vsc-warning)', avatar: 'var(--vsc-warning)' }, // Amber for session agents
  announced: 'var(--vsc-accent)',
  discrete: 'var(--vsc-warning)',
};

// Distinct color palette for connection arrows (to differentiate overlapping paths)
const connectionColors = [
  'var(--vsc-accent)', // violet
  'var(--vsc-link)', // blue
  'var(--vsc-link)', // cyan
  'var(--vsc-success)', // emerald
  'var(--vsc-warning)', // amber
  'var(--vsc-error)', // red
  'var(--vsc-accent)', // pink
  'var(--vsc-accent)', // indigo
  'var(--vsc-success)', // teal
  'var(--vsc-warning)', // orange
  'var(--vsc-success)', // lime
  'var(--vsc-accent)', // purple
];
  ...
  while ((match = regex.exec(text)) !== null) {
    ...
    parts.push(
      <Box
        ...
        sx={{ bgcolor: 'rgba(var(--vsc-accent-rgb), 0.15)', borderRadius: '4px', px: 0.5 }}
      >
        {match[0]}
      </Box>
    );
      ...
      return (
        <>
          ...
          <span
            ref={handoffRef}
            style={{
              backgroundColor: 'rgba(204, 167, 0, 0.14)',
              display: 'inline-block',
              paddingLeft: '4px',
              borderLeft: '3px solid var(--vsc-warning)',
            }}
          >
            {targetSection}
          </span>
      ...
      <Tooltip title="Add handoff target">
        <IconButton
          ...
          sx={{
            ...
            '&:hover': {
              backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.14)',
      ...
      <Tooltip title="View agent details">
        <IconButton
          ...
          sx={{
            ...
            boxShadow: '0 2px 8px rgba(0,0,0,0.1)',
            '&:hover': {
              backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.12)',
              borderColor: 'var(--vsc-link)',
              color: 'var(--vsc-link)',
            },
          }}
        >
    ...
    >
      ...
      {isSelected && (
        <g
          ...
          style={{ cursor: 'pointer' }}
        >
          <circle cx="10" cy="10" r="12" fill="var(--vsc-panel-bg)" stroke="var(--vsc-error)" strokeWidth="2" />
          <text x="10" y="14" textAnchor="middle" fill="var(--vsc-error)" fontSize="14" fontWeight="bold">×</text>
        </g>
      )}
      ...
      <DialogContent>
        <Stack spacing={3} sx={{ mt: 1 }}>
          ...
          <Box>
              ...
              <Stack direction="row" flexWrap="wrap" gap={1}>
                ...
                <Chip
                  ...
                  sx={{
                    cursor: 'pointer',
                    borderStyle: 'dashed',
                    '&:hover': { backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.08)' },
                  }}
                />
              </Stack>
            </Box>
                  ...
                  {HANDOFF_CONDITION_PATTERNS.map((pattern) => (
                    <Paper
                      ...
                      sx={{
                        ...
                        '&:hover': {
                          borderColor: 'var(--vsc-accent)',
                          boxShadow: '0 2px 8px rgba(var(--vsc-accent-rgb), 0.15)',
                        },
                      }}
                    >
              ...
              helperText={
                <span>
                  ...
                  {targetAgent?.description && (
                    <span style={{ display: 'block', marginTop: 4, color: 'var(--vsc-accent)' }}>
            ...
            <Paper
              variant="outlined"
              sx={{ mt: 1.5, p: 1.5, borderRadius: '12px', bgcolor: 'var(--vsc-panel-bg)' }}
            >
              ...
              <Box
                sx={{
                  ...
                  '&::-webkit-scrollbar-thumb': {
                    ...
                    borderRadius: '4px',
                    '&:hover': {
                      backgroundColor: 'var(--vsc-fg-muted)',
                    },
                  },
                }}
              >
          ...
          >
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Stack direction="row" spacing={1.5} alignItems="center">
                <TextFieldsIcon sx={{ fontSize: 18, color: 'var(--vsc-accent)' }} />
                <Box>
                          ...
                          <AccordionDetails>
                            <Stack spacing={2}>
                              ...
                              <Box>
                                ...
                                <Paper
                                  variant="outlined"
                                  sx={{ p: 1.5, borderRadius: '10px', bgcolor: 'var(--vsc-panel-bg)' }}
                                >
                                  <Typography
                                    component="div"
                                    variant="caption"
      ...
      <DialogContent dividers sx={{ p: 0 }}>
        <Stack spacing={0}>
          ...
          {(agent.greeting || agent.return_greeting) && (
            <Box sx={{ p: 2, backgroundColor: 'rgba(78, 201, 176, 0.14)', borderBottom: '1px solid var(--vsc-border)' }}>
              <Typography variant="subtitle2" sx={{ fontWeight: 600, color: 'var(--vsc-success)', mb: 1 }}>
              ...
              <Stack spacing={1}>
                {agent.greeting && (
                  <Box>
                    ...
                    <Paper variant="outlined" sx={{ p: 1.5, backgroundColor: 'var(--vsc-panel-bg)', borderRadius: '8px', mt: 0.5 }}>
          ...
          <Box sx={{ p: 2, borderBottom: '1px solid var(--vsc-border)' }}>
            <Typography variant="subtitle2" sx={{ fontWeight: 600, color: 'var(--vsc-accent)', mb: 1.5 }}>
          ...
          <Box sx={{ p: 2, borderBottom: '1px solid var(--vsc-border)' }}>
            ...
            <Stack spacing={2}>
              {/* Outgoing Handoffs */}
              <Box>
                <Typography variant="caption" sx={{ fontWeight: 600, color: 'var(--vsc-success)' }}>
              ...
              {/* Incoming Handoffs */}
              <Box>
                <Typography variant="caption" sx={{ fontWeight: 600, color: 'var(--vsc-link)' }}>
              ...
              {(handoffTools.length > 0 || legacyHandoffTools.length > 0) && (
                <Box>
                  <Typography variant="caption" sx={{ fontWeight: 600, color: 'var(--vsc-warning)' }}>
                    🔧 Handoff Tools Available
                  </Typography>
                  <Stack direction="row" flexWrap="wrap" gap={1} sx={{ mt: 1 }}>
          ...
          {agent.template_vars && Object.keys(agent.template_vars).length > 0 && (
            <Box sx={{ p: 2, borderBottom: '1px solid var(--vsc-border)' }}>
              <Typography variant="subtitle2" sx={{ fontWeight: 600, color: 'var(--vsc-link)', mb: 1.5 }}>
  ...
  return (
    <Paper
      ...
      sx={{
        ...
        backgroundColor: 'rgba(78, 201, 176, 0.14)',
      }}
    >
      <Typography variant="subtitle2" sx={{ mb: 1, color: 'var(--vsc-success)' }}>
    ...
    <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      {ungraphedAgents.length === 0 ? (
        <Box sx={{
          ...
          <Typography variant="body2" sx={{ fontWeight: 500, color: 'var(--vsc-fg-muted)' }}>
            All agents added
          </Typography>
          <Typography variant="caption" sx={{ color: 'var(--vsc-fg-muted)' }}>
            ...
            <Tooltip title="Click to change icon">
              <Button
                ...
                sx={{
                  ...
                  '&:hover': { borderColor: 'var(--vsc-fg-muted)' },
                }}
              >
                {config.icon}
              </Button>
        ...
        >
          <Box sx={{
            ...
            <Typography variant="subtitle2" sx={{ fontWeight: 600, display: 'flex', alignItems: 'center', gap: 0.5 }}>
              <SmartToyIcon fontSize="small" sx={{ color: 'var(--vsc-accent)' }} />
              Available Agents
            </Typography>
            <Typography variant="caption" sx={{ color: 'var(--vsc-fg-muted)', display: 'block', mt: 0.25 }}>
