...
const styles = {
  ...
  header: {
    background: 'linear-gradient(135deg, var(--vsc-accent) 0%, var(--vsc-link) 50%, var(--vsc-link) 100%)',
    color: 'white',
    padding: '16px 24px',
  ...
  modelCard: {
    ...
    '&:hover': {
      ...
      boxShadow: '0 4px 12px rgba(var(--vsc-accent-rgb), 0.15)',
    },
  },
  modelCardSelected: {
    borderColor: 'var(--vsc-accent)',
...
export default function AgentBuilder({
  ...
  return (
    ...
    >
      ...
      {!loading && isEditMode && (
        <Alert 
          ...
          sx={{ 
            ...
            '& .MuiAlert-icon': { color: 'var(--vsc-warning)' },
          }}
        >
          <Typography variant="body2">
          ...
          <>
                ...
                <Stack direction={{ xs: 'column', md: 'row' }} spacing={2}>
                  <Card variant="outlined" sx={{ ...styles.sectionCard, flex: 1 }}>
                    <CardContent>
                      ...
                      <Stack direction="row" alignItems="center" spacing={2}>
                        <Avatar sx={{ bgcolor: 'rgba(var(--vsc-accent-rgb), 0.14)', color: 'var(--vsc-link)', width: 40, height: 40 }}>
                      ...
                      <Stack direction="row" alignItems="center" spacing={1}>
                        ...
                        <Tooltip title="Refresh agent templates from disk">
                          <IconButton
                            ...
                            sx={{
                              color: 'primary.main',
                              '&:hover': { backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.1)' },
                            }}
                          >
                            {reloadingTemplates ? (
                      ...
                      {templateCards.map((tmpl) => (
                        <Card
                          ...
                          sx={{
                            ...
                            borderColor: tmpl.id === selectedTemplate ? 'var(--vsc-accent)' : 'var(--vsc-border)',
                            boxShadow: tmpl.id === selectedTemplate ? '0 6px 18px rgba(var(--vsc-accent-rgb),0.15)' : 'none',
                        ...
                        >
                          <CardContent sx={{ pb: '12px !important', display: 'flex', flexDirection: 'column', height: '100%' }}>
                            ...
                            <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1 }}>
                              <Avatar sx={{ width: 32, height: 32, bgcolor: tmpl.is_entry_point ? 'var(--vsc-accent)' : 'rgba(var(--vsc-accent-rgb), 0.14)', color: tmpl.is_entry_point ? 'white' : 'var(--vsc-accent)' }}>
                              ...
                              <Box sx={{ flex: 1, minWidth: 0 }}>
                                ...
                                {tmpl.source === 'session' && (
                                  <Typography variant="caption" sx={{ color: 'var(--vsc-accent)', fontWeight: 500 }}>
                                    Session Agent
                                  </Typography>
                                )}
                              </Box>
                                ...
                                {(tmpl.tools?.length || 0) > 4 && (
                                  <Chip
                                    ...
                                    sx={{
                                      height: 22,
                                      fontSize: '0.65rem',
                                      backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.16)',
                                      color: 'var(--vsc-accent)',
                                      '& .MuiChip-label': { px: 1 },
                                    }}
                                  />
                            ...
                            {tmpl.greeting && (
                              <Box sx={{ mb: 1.5, p: 1, backgroundColor: 'var(--vsc-panel-bg)', borderRadius: 1, border: '1px solid var(--vsc-border)' }}>
              ...
              <Stack spacing={2}>
                        ...
                        <TextField
                          ...
                          InputLabelProps={{
                            ...
                            sx: {
                              ...
                              px: 0.5,
                              borderRadius: 0.75,
                              '&.Mui-focused': { color: 'rgba(var(--vsc-accent-rgb), 0.20)' },
                            },
                          }}
                        />
                ...
                <Card variant="outlined" sx={{ ...styles.sectionCard, flex: 1 }}>
                  <CardContent>
                    ...
                    <Card variant="outlined" sx={{ mt: 2, borderColor: 'var(--vsc-fg)' }}>
                      <CardContent>
                        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 1 }}>
                          <Typography variant="subtitle2" color="primary" sx={{ fontWeight: 600 }}>
                            ...
                            {categoryTools.map(tool => (
                              <ListItem
                                ...
                                sx={{ 
                                  cursor: 'pointer',
                                  borderRadius: '8px',
                                  '&:hover': { backgroundColor: 'var(--vsc-panel-bg)' },
                                }}
                              >
                ...
                {(toolFilter === 'all' || toolFilter === 'handoff') && handoffTools.length > 0 && (
                  <Accordion
                    ...
                    sx={{ 
                      ...
                      '&:before': { display: 'none' },
                      boxShadow: 'none',
                      border: '2px solid rgba(var(--vsc-accent-rgb), 0.24)',
                      backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.14)',
                    }}
                  >
                    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
            ...
            <TabPanel value={activeTab} index={3}>
              <Stack spacing={3}>
                      ...
                      renderOption={(props, option) => {
                        ...
                        return (
                          <ListItem {...restProps} key={key}>
                            <ListItemAvatar>
                              <Avatar sx={{ width: 32, height: 32, bgcolor: 'rgba(var(--vsc-accent-rgb), 0.16)' }}>
                ...
                <Card variant="outlined" sx={{ ...styles.sectionCard, bgcolor: 'rgba(var(--vsc-accent-rgb), 0.12)' }}>
                  <CardContent>
                ...
                <Card variant="outlined" sx={styles.sectionCard}>
                  <CardContent>
                    ...
                    <Box sx={{ mt: 2, p: 1.5, borderRadius: 2, border: '1px dashed rgba(var(--vsc-accent-rgb), 0.24)', backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.12)' }}>
                      <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1 }}>
      ...
      {/* Actions */}
      <Divider />
      <DialogActions sx={{ padding: '16px 24px', backgroundColor: 'var(--vsc-panel-bg)' }}>
        <Button
          onClick={handleReset}
        ...
        <Button
          ...
          sx={{
            ...
            boxShadow: isEditMode
              ...
              : '0 4px 14px rgba(var(--vsc-accent-rgb), 0.35)',
            '&:hover': {
              background: isEditMode
                ? 'linear-gradient(135deg, var(--vsc-warning) 0%, var(--vsc-warning) 100%)'
                : 'linear-gradient(135deg, var(--vsc-accent) 0%, var(--vsc-accent) 100%)',
