            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: active
                    ? 'linear-gradient(145deg, rgba(var(--vsc-accent-rgb),0.24), rgba(var(--vsc-accent-rgb),0.12))'
                    : 'linear-gradient(145deg, rgba(255,255,255,0.09), rgba(255,255,255,0.035))',
                  color: active ? 'var(--vsc-link)' : 'var(--vsc-fg-muted)',
                  cursor: "pointer",
                  transition: 'all 0.25s cubic-bezier(0.4, 0, 0.2, 1)',
                  boxShadow: active
                    ? '0 12px 24px rgba(var(--vsc-accent-rgb),0.22), inset 0 1px 0 rgba(255,255,255,0.10)'
                    : '0 10px 20px rgba(0,0,0,0.24), inset 0 1px 0 rgba(255,255,255,0.08)',
                  display: "flex",
                  alignItems: "center",
