...
const PALETTE = {
  cascade: { main: 'var(--vsc-link)', soft: 'rgba(var(--vsc-accent-rgb), 0.14)', deep: 'var(--vsc-link)' },
  voicelive: { main: 'var(--vsc-accent)', soft: 'rgba(var(--vsc-accent-rgb), 0.16)', deep: 'var(--vsc-accent)' },
};
...
const styles = {
  ...
  title: { fontSize: '18px', fontWeight: 800, margin: 0, color: 'var(--vsc-fg)', letterSpacing: '-0.01em' },
  subtitle: { fontSize: '12px', color: 'var(--vsc-fg-muted)', margin: '5px 0 0', lineHeight: 1.55 },
  toggleRow: {
    display: 'flex',
    gap: '6px',
    padding: '5px',
  ...
  flowWrap: {
    ...
    borderRadius: '18px',
    padding: '18px',
    background: 'linear-gradient(180deg, var(--vsc-panel-bg) 0%, var(--vsc-panel-bg) 100%)',
    marginBottom: '16px',
  ...
  endpoint: {
    ...
    padding: '11px 8px',
    borderRadius: '14px',
    background: 'linear-gradient(135deg, var(--vsc-fg) 0%, var(--vsc-fg) 100%)',
    color: 'var(--vsc-fg)',
    fontSize: '10px',
    fontWeight: 600,
    textAlign: 'center',
...
.od-close:hover { background: var(--vsc-input-bg) !important; color: var(--vsc-fg) !important; border-color: var(--vsc-fg) !important; }
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: '13px 11px',
        borderRadius: '14px',
        border: `2px solid ${active ? color.main : 'var(--vsc-border)'}`,
        background: active
          ? `linear-gradient(160deg, var(--vsc-panel-bg) 0%, ${color.soft} 100%)`
          : 'var(--vsc-panel-bg)',
    ...
    >
      <span
        style={{
          ...
          fontSize: '19px',
          lineHeight: 1,
          background: active ? 'var(--vsc-panel-bg)' : color.soft,
      ...
      <span style={{ fontSize: '10.5px', color: 'var(--vsc-fg-muted)' }}>{stage.title}</span>
      <span
        style={{
          marginTop: '5px',
          fontSize: '9px',
...
export function OrchestrationDiagram({ initialMode = 'voicelive' }) {
  ...
  return (
    <div style={styles.root}>
          ...
          return (
            <button
              ...
              style={{
                ...
                background: selected ? 'var(--vsc-panel-bg)' : 'transparent',
                color: selected ? c.deep : 'var(--vsc-fg-muted)',
                fontSize: '12.5px',
          ...
          <div style={{ marginTop: '14px' }}>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      padding: '11px 13px',
                      borderRadius: '12px',
                      border: `1.5px solid ${selected ? color.main : 'var(--vsc-border)'}`,
                      background: selected
                        ? `linear-gradient(160deg, var(--vsc-panel-bg) 0%, ${color.soft} 100%)`
                        : 'var(--vsc-panel-bg)',
                  ...
                  >
                    <div style={{ fontSize: '12px', fontWeight: 800, color: 'var(--vsc-fg)' }}>
                      {a.id === 'native' ? '🎙️ ' : '🔤 '}
                      {a.label}
                    </div>
                    <div style={{ fontSize: '10.5px', color: 'var(--vsc-fg-muted)', marginTop: '3px', lineHeight: 1.45 }}>
                      {a.blurb}
                    </div>
                  </button>
                );
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '2px', flexWrap: 'wrap' }}>
                    ...
                    <div
                      style={{
                        ...
                        background: `linear-gradient(160deg, var(--vsc-panel-bg) 0%, ${color.soft} 100%)`,
                        textAlign: 'center',
                    ...
                    >
                      ...
                      <div style={{ fontSize: '10px', color: 'var(--vsc-fg-muted)' }}>
                  ...
                  <div style={{ display: 'flex', gap: '10px', marginTop: '6px', alignItems: 'stretch' }}>
                    ...
                    <div
                      style={{
                        ...
                        padding: '10px 12px',
                        borderRadius: '12px',
                        border: '1px dashed var(--vsc-fg)',
                        background: 'linear-gradient(160deg, var(--vsc-panel-bg) 0%, var(--vsc-panel-bg) 100%)',
                      }}
                    >
                      <div style={{ fontSize: '11.5px', fontWeight: 700, color: 'var(--vsc-fg-muted)' }}>
                        📝 Transcript — a “best guess”
                      </div>
                      <div style={{ fontSize: '10.5px', color: 'var(--vsc-fg-muted)', marginTop: '3px', lineHeight: 1.5 }}>
            ...
            {vlArch === 'cascaded' && (
              ...
              >
                ...
                <div style={{ fontSize: '10.5px', color: 'var(--vsc-fg-muted)', marginTop: '10px', lineHeight: 1.5 }}>
      ...
      >
        ...
        <div
          style={{
            ...
            height: '10px',
            borderRadius: '999px',
            background: `linear-gradient(90deg, ${PALETTE.voicelive.main}, var(--vsc-link) 45%, var(--vsc-link) 55%, ${PALETTE.cascade.main})`,
            boxShadow: '0 2px 8px rgba(var(--vsc-accent-rgb),0.25)',
          }}
        >
          ...
          return (
            <div
              ...
              style={{
                ...
                borderRadius: '16px',
                padding: '15px',
                border: `2px solid ${isActive ? c.main : 'var(--vsc-border)'}`,
                background: isActive
                  ? `linear-gradient(160deg, var(--vsc-panel-bg) 0%, ${c.soft} 100%)`
                  : 'var(--vsc-panel-bg)',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                ...
                <div>
                  <div style={{ fontSize: '13px', fontWeight: 800, color: 'var(--vsc-fg)' }}>{card.name}</div>
              ...
              <div style={{ fontSize: '10.5px', color: 'var(--vsc-fg-muted)', fontStyle: 'italic', lineHeight: 1.45 }}>
                {card.bestFor}
              </div>
            </div>
          );
      ...
      <p style={{ fontSize: '10.5px', color: 'var(--vsc-fg-muted)', margin: '12px 2px 0', lineHeight: 1.5 }}>
