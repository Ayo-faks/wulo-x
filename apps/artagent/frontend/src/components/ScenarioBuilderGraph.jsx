...
const colors = {
  start: { bg: 'rgba(78, 201, 176, 0.14)', border: 'var(--vsc-success)', avatar: 'var(--vsc-success)', text: 'var(--vsc-success)' },
  active: { bg: 'rgba(var(--vsc-accent-rgb), 0.14)', border: 'var(--vsc-accent)', avatar: 'var(--vsc-accent)', text: 'var(--vsc-accent)' },
  session: { bg: 'rgba(204, 167, 0, 0.18)', border: 'var(--vsc-warning)', avatar: 'var(--vsc-warning)', text: 'var(--vsc-warning)' },
  selected: { bg: 'rgba(var(--vsc-accent-rgb), 0.18)', border: 'var(--vsc-link)', avatar: 'var(--vsc-accent)', text: 'var(--vsc-link)' },
  invalid: { bg: 'rgba(241, 76, 76, 0.14)', border: 'var(--vsc-error)', avatar: 'var(--vsc-error)', text: 'var(--vsc-error)' },
};
...
function HighlightedPromptPreview({ previewData, targetAgent }) {
    ...
    if (targetStartIdx !== -1) {
      ...
      return (
        <>
          ...
          <span style={{ backgroundColor: 'rgba(204, 167, 0, 0.18)', color: 'var(--vsc-warning)', padding: '2px 4px', borderRadius: '3px', fontWeight: 600 }}>
            ## Agent Handoff Instructions
          </span>
          <span>{beforeTarget}</span>
          <span ref={handoffRef} style={{ backgroundColor: 'rgba(204, 167, 0, 0.14)', display: 'inline-block', paddingLeft: '4px', borderLeft: '3px solid var(--vsc-warning)' }}>
            {targetSection}
          </span>
  ...
  return (
    <>
      ...
      <span ref={handoffRef} style={{ backgroundColor: 'rgba(204, 167, 0, 0.14)' }}>
        {handoffSection}
      </span>
    </>
  );
    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent dividers>
        <Stack spacing={3} sx={{ mt: 1 }}>
          ...
          <Paper variant="outlined" sx={{ p: 2, backgroundColor: 'var(--vsc-panel-bg)', borderRadius: 2 }}>
            ...
            <Stack direction="row" alignItems="center" justifyContent="center" spacing={2}>
              ...
              <Tooltip title="Click to change source agent" arrow>
                <Chip
                  ...
                  sx={{
                    ...
                    '&:hover': {
                      borderColor: 'var(--vsc-accent)',
                      backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.08)',
                    },
                  }}
              ...
              <ArrowForwardIcon sx={{ color: 'var(--vsc-accent)' }} />
                ...
                <>
                  ...
                  {sourceAgentCategories.inCanvas.map((agent) => (
                    ...
                    >
                      ...
                      {agent.name === fromAgent && <CheckIcon sx={{ ml: 1, color: 'var(--vsc-accent)', fontSize: 18 }} />}
                    </MenuItem>
                  ))}
                </>
              )}
                ...
                <>
                  ...
                  {targetAgentCategories.inCanvas.map((agent) => (
                    ...
                    >
                      ...
                      {agent.name === toAgent && <CheckIcon sx={{ ml: 1, color: 'var(--vsc-success)', fontSize: 18 }} />}
                    </MenuItem>
                  ))}
                </>
              )}
          ...
          <Box>
            <Typography variant="subtitle2" gutterBottom sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1.5 }}>
              <AutoFixHighIcon sx={{ fontSize: 16, color: 'var(--vsc-accent)' }} />
            ...
            <Box sx={{ mb: 2 }}>
              <Stack direction="row" flexWrap="wrap" gap={1}>
                  ...
                  return (
                    <Chip
                      ...
                      sx={{
                        ...
                        '&:hover': { backgroundColor: selectedPattern === pattern.id ? undefined : 'rgba(var(--vsc-accent-rgb), 0.08)' },
                      }}
                    />
                  );
                })}
                <Chip
                  ...
                  variant="outlined"
                  sx={{ cursor: 'pointer', borderStyle: 'dashed', '&:hover': { backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.08)' } }}
                />
              </Stack>
            </Box>
            ...
            <Collapse in={showPatternPicker}>
              <Paper variant="outlined" sx={{ p: 2, mb: 2, borderRadius: '12px', backgroundColor: 'var(--vsc-panel-bg)' }}>
                    ...
                    return (
                      <Paper
                        ...
                        sx={{
                          ...
                          cursor: 'pointer',
                          borderRadius: '8px',
                          borderColor: selectedPattern === pattern.id ? 'var(--vsc-accent)' : 'var(--vsc-border)',
                          backgroundColor: selectedPattern === pattern.id ? 'rgba(var(--vsc-accent-rgb), 0.08)' : 'var(--vsc-panel-bg)',
                          transition: 'all 0.2s',
                          '&:hover': { borderColor: 'var(--vsc-accent)', boxShadow: '0 2px 8px rgba(var(--vsc-accent-rgb), 0.15)' },
                        }}
                      >
                        <Stack direction="row" spacing={1} alignItems="flex-start">
                          <Icon sx={{ fontSize: 22, color: selectedPattern === pattern.id ? 'var(--vsc-accent)' : 'var(--vsc-fg-muted)' }} />
                          <Box sx={{ flex: 1 }}>
                          ...
                          {selectedPattern === pattern.id && (
                            <CheckIcon sx={{ color: 'var(--vsc-accent)', fontSize: 18 }} />
                          )}
                        </Stack>
                      </Paper>
                    );
            ...
            <Paper variant="outlined" sx={{ mt: 1.5, p: 1.5, borderRadius: '12px', bgcolor: 'var(--vsc-panel-bg)' }}>
              <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 1 }}>
                <Stack direction="row" alignItems="center" spacing={0.75}>
                  <Typography variant="caption" color="text.secondary">
                    <strong style={{ color: 'var(--vsc-accent)' }}>{fromAgent}</strong>'s Runtime System Prompt
                  </Typography>
                  <Chip
                    label="Source Agent"
                    size="small"
              ...
              <Select value={type} onChange={(e) => setType(e.target.value)} label="Handoff Type">
                <MenuItem value="announced">
                  <Stack direction="row" alignItems="center" gap={1}>
                    <VolumeUpIcon fontSize="small" sx={{ color: 'var(--vsc-accent)' }} />
                    Announced
                  </Stack>
                </MenuItem>
                <MenuItem value="discrete">
                  <Stack direction="row" alignItems="center" gap={1}>
                    <VolumeOffIcon fontSize="small" sx={{ color: 'var(--vsc-warning)' }} />
                    Discrete (silent)
                  </Stack>
                </MenuItem>
              </Select>
...
const ScenarioGraphCanvas = React.memo(function ScenarioGraphCanvas({
  ...
  return (
    <Box sx={{ display: 'flex', height: '100%', overflow: 'hidden' }}>
      ...
      >
        {onCreateAgent && (
          <Box sx={{ p: 1.5, borderBottom: '1px solid var(--vsc-border)' }}>
            <Button
              variant="outlined"
              size="small"
              fullWidth
        ...
        <Box sx={{ p: 1.5, borderBottom: '1px solid var(--vsc-border)', backgroundColor: 'var(--vsc-panel-bg)' }}>
          <Stack direction="row" alignItems="center" spacing={1}>
            <AddIcon fontSize="small" sx={{ color: 'var(--vsc-accent)' }} />
            <Typography variant="subtitle2" sx={{ fontWeight: 600 }}>
              Add to Flow
            </Typography>
          </Stack>
          <Typography variant="caption" sx={{ color: 'var(--vsc-fg-muted)', display: 'block', mt: 0.5 }}>
        ...
        <Box sx={{ flex: 1, overflowY: 'auto', p: 1 }}>
          {availableAgents.map(agent => {
            ...
            return (
              ...
              >
                <Stack direction="row" alignItems="center" spacing={1}>
                  <DragIndicatorIcon sx={{ fontSize: 16, color: 'var(--vsc-fg-muted)', mr: -0.5 }} />
                  <Avatar
                    sx={{
                      width: 28,
                      height: 28,
                  ...
                  <Tooltip title="View details">
                    <IconButton
                      ...
                      sx={{ p: 0.5 }}
                    >
                      <SettingsIcon sx={{ fontSize: 14, color: 'var(--vsc-fg-muted)' }} />
                    </IconButton>
                  </Tooltip>
                </Stack>
              </Paper>
          ...
          {availableAgents.length === 0 && (
            <Box sx={{ textAlign: 'center', py: 4, color: 'var(--vsc-fg-muted)' }}>
      ...
      <Box
        ...
        sx={{
          ...
          position: 'relative',
          backgroundColor: 'var(--vsc-panel-bg)',
          backgroundImage: 'radial-gradient(circle, var(--vsc-border) 1px, transparent 1px)',
      ...
      >
        ...
        >
          ...
          <defs>
            ...
            <marker id="arrowhead-announced" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
              <polygon points="0 0, 10 3.5, 0 7" fill="var(--vsc-accent)" />
            </marker>
            <marker id="arrowhead-discrete" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
              <polygon points="0 0, 10 3.5, 0 7" fill="var(--vsc-warning)" />
            </marker>
            ...
            <marker id="arrowhead-reverse-announced" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
              <polygon points="0 0, 10 3.5, 0 7" fill="var(--vsc-success)" />
            </marker>
          ...
          {edges.map(edge => {
            ...
            const getEdgeColor = () => {
              if (isSelected) return 'var(--vsc-link)';
              if (isBidirectional) return isAnnounced ? 'var(--vsc-success)' : 'var(--vsc-success)';
              return isAnnounced ? 'var(--vsc-accent)' : 'var(--vsc-warning)';
            };
              ...
              <g key={edge.id} style={{ cursor: 'pointer', pointerEvents: 'auto' }} onClick={(e) => handleEdgeClick(edge, e)}>
                ...
                <g transform={`translate(${(edge.fromX + edge.toX) / 2}, ${midY})`}>
                  <rect
                    ...
                    height="28"
                    rx="14"
                    fill={isSelected ? 'rgba(var(--vsc-accent-rgb), 0.18)' : (isBidirectional ? 'rgba(78, 201, 176, 0.14)' : 'white')}
                    stroke={edgeColor}
          ...
          return (
            ...
            >
                ...
                <Tooltip title="This agent needs an incoming connection. Drag from another agent's output port to connect.">
                  <Box
                    sx={{
                      ...
                      border: '1px solid rgba(241, 76, 76, 0.24)',
                      borderRadius: '8px',
                      px: 1,
                      py: 0.25,
                      display: 'flex',
                  ...
                  >
                    <Typography variant="caption" sx={{ color: 'var(--vsc-error)', fontWeight: 600, fontSize: 9 }}>
                      ⚠️ Needs connection
                    </Typography>
                  </Box>
                </Tooltip>
              ...
              <Paper
                ...
                sx={{
                  height: node.height,
                  background: isConnectTarget ? 'rgba(var(--vsc-accent-rgb), 0.18)' : nodeColors.bg,
                  border: `2px solid ${isConnectTarget ? 'var(--vsc-link)' : nodeColors.border}`,
                  borderRadius: '12px',
                ...
                >
                  <Box
                    ...
                    sx={{
                      ...
                      borderRadius: '50%',
                      backgroundColor: connectingFrom === node.id ? 'var(--vsc-link)' : 'var(--vsc-accent)',
                      border: `2px solid ${connectingFrom === node.id ? 'var(--vsc-accent)' : 'var(--vsc-accent)'}`,
                      cursor: 'pointer',
                      zIndex: 10,
                      ...
                      '&:hover': {
                        ...
                        boxShadow: '0 0 12px rgba(var(--vsc-accent-rgb), 0.6)',
                      },
                    }}
                  >
        ...
        {nodes.length === 0 && (
          ...
          >
            ...
            <Typography variant="h6" sx={{ fontWeight: 600, color: 'var(--vsc-fg-muted)' }}>
              Click an agent to start
            </Typography>
            <Typography variant="body2" sx={{ color: 'var(--vsc-fg-muted)', mt: 1 }}>
            ...
            <Tooltip title="Reset pan (center view)">
              <IconButton
                ...
                sx={{
                  ...
                  border: '1px solid var(--vsc-border)',
                  '&:hover': { backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.12)' },
                }}
              >
                <GpsFixedIcon fontSize="small" sx={{ color: 'var(--vsc-link)' }} />
              </IconButton>
            </Tooltip>
          )}
                ...
                <Tooltip title="Set as start agent">
                  <IconButton
                    ...
                    sx={{
                      backgroundColor: 'white',
                      border: '1px solid var(--vsc-border)',
                      '&:hover': { backgroundColor: 'rgba(78, 201, 176, 0.14)' },
                    }}
                  >
                    <PlayArrowIcon fontSize="small" sx={{ color: 'var(--vsc-success)' }} />
                  </IconButton>
                </Tooltip>
              )}
              <Tooltip title="Remove from flow">
                <IconButton
                  ...
                  sx={{
                    backgroundColor: 'white',
                    border: '1px solid var(--vsc-border)',
                    '&:hover': { backgroundColor: 'rgba(241, 76, 76, 0.14)' },
                  }}
                >
                  <DeleteIcon fontSize="small" sx={{ color: 'var(--vsc-error)' }} />
                </IconButton>
              </Tooltip>
            </>
          )}
          {connectingFrom && (
            <Tooltip title="Cancel connection">
              <Button
                ...
                sx={{
                  backgroundColor: 'var(--vsc-error)',
                  '&:hover': { backgroundColor: 'var(--vsc-error)' },
                }}
              >
                Cancel
              </Button>
                ...
                {config.handoffs.map((h, i) => (
                  <Chip
                    ...
                    sx={{
                      ...
                      '&:hover': { backgroundColor: 'var(--vsc-fg)' },
                    }}
                  />
                ))}
              </Stack>
          ...
          {nodes.some(n => n.isFloating) && (
            <Paper 
              ...
              sx={{ 
                ...
                borderRadius: '10px', 
                backgroundColor: 'rgba(241, 76, 76, 0.14)',
                borderColor: 'rgba(241, 76, 76, 0.24)',
              }}
            >
              <Typography variant="caption" sx={{ color: 'var(--vsc-error)', fontWeight: 600 }}>
                ⚠️ Floating Agents
              </Typography>
              <Typography variant="caption" sx={{ display: 'block', color: 'var(--vsc-error)', mt: 0.5 }}>
...
export default function ScenarioBuilderGraph({
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', position: 'relative' }}>
      ...
      {/* Header */}
      <Box sx={{ p: 2, borderBottom: '1px solid var(--vsc-border)' }}>
        ...
        <DialogContent dividers>
          <Stack spacing={3}>
            ...
            <Box>
              ...
              <Paper variant="outlined" sx={{ p: 2, backgroundColor: 'var(--vsc-panel-bg)', position: 'relative' }}>
                <Typography
                  component="pre"
                  variant="body2"
                  sx={{
            ...
            <Box>
              ...
              <Paper variant="outlined" sx={{ p: 1.5, backgroundColor: 'var(--vsc-editor-bg)', borderRadius: 1 }}>
                <Typography
                  component="code"
                  variant="body2"
                  sx={{ fontFamily: 'monospace', color: 'var(--vsc-link)', fontSize: 13 }}
                >
            ...
            <Box>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
                Create a file named <code style={{ backgroundColor: 'var(--vsc-fg)', padding: '2px 6px', borderRadius: 4 }}>orchestration.yaml</code> (or <code style={{ backgroundColor: 'var(--vsc-fg)', padding: '2px 6px', borderRadius: 4 }}>scenario.yaml</code>) in the new directory and paste the YAML content:
              </Typography>
              <Paper variant="outlined" sx={{ p: 1.5, backgroundColor: 'var(--vsc-editor-bg)', borderRadius: 1 }}>
                <Typography
                  component="code"
            ...
            {/* Info Box */}
            <Paper sx={{ p: 2, backgroundColor: 'var(--vsc-panel-bg)', border: '1px solid rgba(var(--vsc-accent-rgb), 0.28)' }}>
              <Typography variant="body2" sx={{ fontWeight: 600, color: 'var(--vsc-link)', mb: 1 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                ...
                <code style={{ backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.18)', padding: '2px 6px', borderRadius: 4, fontSize: 12 }}>
      ...
      >
        ...
        <Button
          ...
          sx={{
            background: editMode
              ? 'linear-gradient(135deg, var(--vsc-warning) 0%, var(--vsc-warning) 100%)'
              : 'linear-gradient(135deg, var(--vsc-accent) 0%, var(--vsc-accent) 100%)',
          }}
        >
