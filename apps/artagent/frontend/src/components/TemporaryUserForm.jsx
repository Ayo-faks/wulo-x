...
const formStyles = {
  ...
  input: {
    ...
    fontWeight: 500,
    WebkitTextFillColor: 'var(--vsc-fg)',
    MozAppearance: 'none',
    appearance: 'none',
  ...
  modeButton: (active) => ({
    ...
    borderRadius: '999px',
    border: '1px solid',
    borderColor: active ? 'var(--vsc-accent)' : 'rgba(148,163,184,0.5)',
    backgroundColor: active ? 'var(--vsc-accent)' : 'var(--vsc-panel-bg)',
    color: active ? 'var(--vsc-fg-strong)' : 'var(--vsc-fg)',
    fontWeight: 600,
    fontSize: '12px',
  ...
  ssnBanner: {
    padding: '14px 16px',
    borderRadius: '12px',
    backgroundColor: 'var(--vsc-warning)',
    color: 'var(--vsc-fg-strong)',
    fontWeight: 700,
    fontSize: '14px',
    textAlign: 'center',
    ...
    <section style={{
        ...
        <div style={{ ...formStyles.modeSwitcher, marginTop: '12px' }}>
          <button
            ...
            style={{
              ...
              backgroundColor: scenario === 'banking' ? 'var(--vsc-accent)' : 'var(--vsc-panel-bg)',
              borderColor: scenario === 'banking' ? 'var(--vsc-accent)' : 'rgba(148,163,184,0.5)',
            }}
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: scenario === 'insurance' ? 'var(--vsc-success)' : 'var(--vsc-panel-bg)',
              borderColor: scenario === 'insurance' ? 'var(--vsc-success)' : 'rgba(148,163,184,0.5)',
            }}
      ...
      {status.type === 'success' && (
        <div style={{ ...formStyles.resultCard, animation: 'slideInUp 0.35s ease-out' }}>
          <div style={{ fontSize: '12px', fontWeight: 700, color: 'var(--vsc-fg)', textTransform: 'uppercase', letterSpacing: '0.06em', display: 'flex', alignItems: 'center', gap: '8px' }}>
