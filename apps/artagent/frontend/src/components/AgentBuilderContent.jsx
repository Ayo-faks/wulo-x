...
const styles = {
  ...
  tabPanel: {
    ...
    overflowY: 'auto',
    backgroundColor: 'var(--vsc-fg-strong)',
  },
  sectionCard: {
    borderRadius: '12px',
    ...
    boxShadow: 'none',
    '&:hover': {
      borderColor: 'rgba(var(--vsc-accent-rgb), 0.24)',
      boxShadow: '0 2px 8px rgba(var(--vsc-accent-rgb), 0.08)',
    },
  },
  promptEditor: {
    ...
    '& .MuiInputBase-root': {
      backgroundColor: 'var(--vsc-panel-bg)',
      color: 'rgba(var(--vsc-accent-rgb), 0.20)',
      borderRadius: '8px',
    },
    '& .MuiInputBase-input': {
      color: 'rgba(var(--vsc-accent-rgb), 0.20)',
        ...
        <Collapse in={expanded} timeout="auto">
          ...
          <Stack spacing={1.5}>
            {Object.entries(varsBySource).map(([source, docs]) => (
              <Box key={source}>
                <Typography variant="caption" sx={{ fontWeight: 700, color: 'var(--vsc-fg-muted)', mb: 0.5, display: 'block' }}>
                  {source}
                </Typography>
                      ...
                      <Tooltip
                        ...
                        title={
                          <Box sx={{ p: 0.5 }}>
                            ...
                            <Typography variant="caption" sx={{ fontFamily: 'monospace', color: 'var(--vsc-link)' }}>
                              {doc.example}
                            </Typography>
                            <Typography variant="caption" display="block" sx={{ mt: 0.5, color: 'var(--vsc-link)' }}>
                              Type: {doc.type}
                            </Typography>
                          </Box>
                        }
...
const InlineVariablePicker = React.memo(function InlineVariablePicker({ onInsert, usedVars = [] }) {
  ...
  return (
    <Box sx={{ mt: 0.5 }}>
      ...
      <Collapse in={expanded} timeout="auto">
        <Box sx={{ mt: 1, p: 1.5, backgroundColor: 'var(--vsc-panel-bg)', borderRadius: '8px', border: '1px solid var(--vsc-border)' }}>
          ...
          <Typography variant="caption" sx={{ display: 'block', mt: 1, color: 'var(--vsc-fg-muted)' }}>
    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle sx={{ pb: 1 }}>
        <Stack direction="row" alignItems="center" spacing={2}>
          <Avatar sx={{ bgcolor: 'var(--vsc-link)' }}>
            {agent?.name?.[0] || 'A'}
          </Avatar>
    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      <DialogTitle sx={{ pb: 1 }}>
        <Stack direction="row" alignItems="center" spacing={1}>
          ...
          >
            <BuildIcon sx={{ fontSize: 16, color: 'var(--vsc-accent)' }} />
          </Box>
          <Box sx={{ flex: 1, minWidth: 0 }}>
        ...
        <Stack spacing={2}>
          ...
          {parameters && (
            <Box>
              ...
              <Paper variant="outlined" sx={{ p: 1.5, borderRadius: 2, backgroundColor: 'var(--vsc-fg)' }}>
                <Typography
                  component="pre"
                  sx={{
                    fontFamily: 'monospace',
...
export default function AgentBuilderContent({
      ...
      <Card
        ...
        sx={{
          ...
          '&:hover': {
            ...
            boxShadow: '0 4px 12px rgba(var(--vsc-accent-rgb),0.1)',
          },
        }}
      >
        <CardContent sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1 }}>
            <Avatar sx={{ width: 32, height: 32, bgcolor: 'var(--vsc-link)' }}>
              {agent?.name?.[0] || 'A'}
            </Avatar>
            <Box sx={{ flex: 1, minWidth: 0 }}>
          ...
          >
            ...
            >
              ...
              <Typography variant="body2" sx={{ fontWeight: 600, color: 'var(--vsc-fg)' }}>
                {toolCount}
              </Typography>
              ...
              <Typography
                variant="body2"
                sx={{ fontWeight: 600, color: 'var(--vsc-fg)', wordBreak: 'break-word' }}
                title={cascadeLabel}
              >
                {cascadeLabel}
              </Typography>
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                ...
                >
                  ...
                  >
                    <Stack direction="row" alignItems="center" spacing={1} sx={{ width: '100%' }}>
                      <LinkIcon sx={{ color: 'var(--vsc-accent)', fontSize: 18 }} />
                      <Typography variant="subtitle2" sx={{ fontWeight: 600, color: 'var(--vsc-accent)' }}>
                        MCP Servers
                      </Typography>
                      <Chip
                        size="small"
                  ...
                  <AccordionDetails sx={{ pt: 0, pb: 1.5, backgroundColor: 'var(--vsc-fg-strong)' }}>
                    <Stack spacing={1.5}>
                      <Typography variant="caption" color="text.secondary">
                        ...
                        <Stack spacing={1}>
                          {mcpServers.map((server) => (
                            <Paper
                              ...
                              sx={{
                                p: 1,
                                borderColor: server.status === 'healthy' ? 'rgba(78, 201, 176, 0.24)' : 'rgba(241, 76, 76, 0.24)',
                                backgroundColor: server.status === 'healthy' ? 'rgba(78, 201, 176, 0.14)' : 'rgba(241, 76, 76, 0.14)',
                              }}
                            >
                              <Stack direction="row" alignItems="center" justifyContent="space-between">
                                <Stack direction="row" alignItems="center" spacing={1}>
                                  {server.status === 'healthy' ? (
                                    <LinkIcon sx={{ color: 'var(--vsc-success)', fontSize: 16 }} />
                                  ) : (
                                    <LinkOffIcon sx={{ color: 'var(--vsc-error)', fontSize: 16 }} />
                                  )}
                                  <Box>
                                  ...
                                  {server.source === 'runtime' && (
                                    <Tooltip title="Remove server">
                                      <IconButton
                                        ...
                                        disabled={mcpLoading}
                                      >
                                        <DeleteIcon sx={{ fontSize: 16, color: 'var(--vsc-error)' }} />
                                      </IconButton>
                                    </Tooltip>
                                  )}
                                </Stack>
                    ...
                    <ToggleButton
                      ...
                      sx={{
                        '&.Mui-selected': {
                          ...
                          boxShadow: '0 0 0 1px var(--mui-palette-primary-main, var(--vsc-accent)) inset',
                    ...
                    <ToggleButton
                      ...
                      sx={{
                        '&.Mui-selected': {
                          ...
                          boxShadow: '0 0 0 1px var(--mui-palette-secondary-main, var(--vsc-accent)) inset',
                        ...
                        <TextField
                          ...
                          sx={{
                            '& .MuiOutlinedInput-root': {
                              ...
                              '& fieldset': { borderColor: 'rgba(204, 167, 0, 0.22)' },
                              '&:hover fieldset': { borderColor: 'var(--vsc-warning)' },
                              '&.Mui-focused fieldset': { borderColor: 'var(--vsc-warning)' },
                            },
                          }}
                        />
                      )}
                ...
                <Accordion defaultExpanded>
                  ...
                  <AccordionDetails>
                    <Stack spacing={3}>
                      ...
                      <Box sx={{ p: 1.5, borderRadius: 2, border: '1px dashed rgba(var(--vsc-accent-rgb), 0.24)', backgroundColor: 'rgba(var(--vsc-accent-rgb), 0.12)' }}>
                        <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1 }}>
                          <MemoryIcon sx={{ fontSize: 16, color: 'var(--vsc-accent)' }} />
                          <Typography variant="caption" sx={{ fontWeight: 700, color: 'var(--vsc-accent)' }}>
          ...
          <Stack spacing={2.5}>
            ...
            {mcpTestResult && (
              <Paper
                ...
                sx={{
                  p: 2,
                  borderColor: mcpTestResult.connected ? 'rgba(78, 201, 176, 0.24)' : 'rgba(241, 76, 76, 0.24)',
                  backgroundColor: mcpTestResult.connected ? 'rgba(78, 201, 176, 0.14)' : 'rgba(241, 76, 76, 0.14)',
                }}
              >
                <Stack spacing={1}>
                  <Stack direction="row" alignItems="center" spacing={1}>
                    {mcpTestResult.connected ? (
                      <CheckIcon sx={{ color: 'var(--vsc-success)' }} />
                    ) : (
                      <WarningAmberIcon sx={{ color: 'var(--vsc-error)' }} />
                    )}
      ...
      {/* Footer */}
      <Divider />
      <Box sx={{ p: 2, backgroundColor: 'var(--vsc-panel-bg)', display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
      ...
      >
        ...
        <DialogContent dividers>
          <Stack spacing={3}>
            ...
            {/* Info Box */}
            <Paper sx={{ p: 2, backgroundColor: 'rgba(204, 167, 0, 0.18)', border: '1px solid var(--vsc-warning)' }}>
              <Typography variant="body2" sx={{ fontWeight: 600, color: 'var(--vsc-warning)', mb: 1 }}>
                ⚠️ Important Notes
              </Typography>
              <Typography variant="body2" color="text.secondary" component="div">
                <ul style={{ margin: '4px 0', paddingLeft: 20 }}>
                  <li>The YAML export includes the prompt as comments. Extract it into a separate <code style={{ backgroundColor: 'rgba(204, 167, 0, 0.20)', padding: '2px 4px', borderRadius: 2 }}>prompt.jinja</code> file</li>
