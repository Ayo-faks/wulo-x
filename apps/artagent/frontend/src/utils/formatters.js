...
export const STATUS_TONE_META = {
  info: {
    ...
    textColor: 'var(--vsc-fg)',
    captionColor: 'rgba(15,23,42,0.65)',
  },
  success: {
    label: 'Event',
    accent: 'var(--vsc-success)',
    ...
    textColor: 'var(--vsc-success)',
    captionColor: 'rgba(6,78,59,0.7)',
  },
  warning: {
    label: 'Warning',
    accent: 'var(--vsc-warning)',
