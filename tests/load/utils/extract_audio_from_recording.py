...
class AudioExtractorFromRecording:
    ...
    def __init__(self, speech_subscription: str = None, speech_region: str = None):
        """Initialize with Azure Speech Service credentials."""
        self.speech_subscription = speech_subscription or os.getenv("AZURE_SPEECH_KEY")
        self.speech_region = speech_region or os.getenv("AZURE_SPEECH_REGION")

        if not self.speech_subscription or not self.speech_region:
            ...
            speech_config = speechsdk.SpeechConfig(
                subscription=self.speech_subscription, region=self.speech_region
            )
...
def main():
    ...
    try:
        extractor = AudioExtractorFromRecording(
            speech_subscription=args.speech_subscription,
