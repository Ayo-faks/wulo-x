...
Purchase a toll-free phone number:
    python acs_purchase_phone_number.py purchase --country-code GB --phone-number-type TOLL_FREE
Purchase a geographic phone number:
    python acs_purchase_phone_number.py purchase --country-code GB --phone-number-type GEOGRAPHIC
Release an existing phone number:
    python acs_purchase_phone_number.py release +12025550106
...
def main():
    ...
    purchase_parser.add_argument("--country-code", default="GB", help="Country code (default: GB)")
    purchase_parser.add_argument("--area-code", default=None, help="Optional area code")
    ...
    release_parser.add_argument("phone_number", help="Phone number to release (e.g., +12025550100)")
